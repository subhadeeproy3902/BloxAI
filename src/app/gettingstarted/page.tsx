    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <section className="mb-12">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 rounded-lg mb-8">
        ...
        <section className="mb-12">
          <h1 className="text-3xl font-bold mb-5 text-center">Features</h1>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  <span className="bg-blue-600 text-white rounded-full w-10 h-10 flex justify-center items-center p-2 mr-6">1</span>
                  <p className="text-xl font-semibold">Open the Excalidraw canvas</p>
                </div>
                <div className="flex items-center">
                  <span className="bg-blue-600 text-white rounded-full w-10 h-10 flex justify-center items-center p-2 mr-6">2</span>
                  <p className="text-xl font-semibold">Start drawing your diagrams</p>
                </div>
                <div className="flex items-center">
                  <span className="bg-blue-600 text-white rounded-full w-10 h-10 flex justify-center items-center p-2 mr-6">3</span>
                  <p className="text-xl font-semibold">Collaborate with your team in real-time</p>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                  <h3 className="text-2xl font-bold mb-4">Can I collaborate with my team?</h3>
                  <p className="text-gray-800">
                ...
                <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                  <h3 className="text-2xl font-bold mb-4">Is BloxAI secure and private?</h3>
                  <p className="text-gray-800">
                    Absolutely! We prioritize security and privacy, ensuring that your data is safe and secure at all times.
                  </p>
                </div>
                <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                  <h3 className="text-2xl font-bold mb-4">Can I export my diagrams?</h3>
                  <p className="text-gray-800">
        ...
        <section className="mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="font-bold text-gray-600">- John Doe, Project Manager</p>
            </div>
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              <p className="text-gray-800 mb-4">
              ...
              <p className="font-bold text-gray-600">- Jane Smith, Team Lead</p>
            </div>
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              <p className="text-gray-800 mb-4">
              ...
              <p className="font-bold text-gray-600">- Bob Johnson, Product Manager</p>
            </div>
          </div>
        </section>
