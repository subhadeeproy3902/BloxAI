...
const Header = () => {
  ...
  return (
    <header className="dark:bg-background border-b sticky">
      ...
      {menuOpen && (
        <div className="md:hidden dark:bg-background absolute z-[9999] w-full h-fit flex flex-col items-center justify-start text-center gap-7 pt-5 pb-5 border-b-4">
          {links.map((link, index) => (
