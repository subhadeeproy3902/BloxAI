  ...
  return (
    <div className="min-h-[40rem] w-full pt-16 rounded-md flex justify-center flex-col antialiased relative overflow-hidden">
      <div className="mx-auto max-w-2xl px-4 py-8">
        <h1 className="text-3xl font-bold text-foreground/75">
          Contributor Covenant Code of Conduct
        </h1>

        <h2 className="mt-8 mb-2 text-2xl font-semibold text-foreground/75">
          Our Pledge
        </h2>
        ...
        <p className="text-muted-foreground">
          ...
          <a
            ...
            className="text-foreground/75 underline"
          >
        ...
        <h3 className="mt-4 mb-2 text-xl font-semibold text-foreground/75">
          1. Correction
        </h3>
        <p className="text-muted-foreground">
